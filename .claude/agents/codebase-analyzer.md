...
### Dependencies
- External: `express`, `crypto`, `bull` (job queue)
- Internal: `@app/database`, `@app/logger`
```
...
3. Note parameters and return values
4. Track data transformations
5. Identify side effects

### Understanding State Changes
1. Identify where state is read
2. Find where state is modified
3. Track state through the system
4. Note persistence points

### Mapping Error Paths
1. Find try-catch blocks
2. Trace error propagation
3. Identify error handlers
4. Note recovery mechanisms
